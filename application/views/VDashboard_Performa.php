...
<body>
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3.5">
                                            <h5 class="card-subtitle" style="margin-left: 120px; margin-top:5px; color: #696969;">1 Agustus - 7 Agustus</h5>
                                        </div>
                                        <div class="col-lg-1">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3.5">
                                            <h5 class="card-subtitle" style="margin-left: 330px; margin-top:5px; color: #696969;">Agustus 2019</h5>
                                        </div>
                                        <div class="col-lg-1">
                                            <i class="fas fa-angle-left" style="margin-left:5px; margin-top:10px; color: #696969;" ></i>
                                            <i class="fas fa-angle-right" style="margin-left: 10px; margin-top:10px; color: #696969"></i>
    ...
    <!-- DASHBOARD 1 -->
    <!-- ============================================================== -->
    <script src="assets/dist/js/pages/dashboards/dashboardperforma.js"></script>
    <script src="assets/libs/gaugeJS/dist/gauge.min.js"></script>
    <script src="assets/libs/chart.js/dist/Chart.min.js"></script>
