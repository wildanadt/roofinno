                    ...
                    <div class="col-12">
                        <div class="card bg-transparent">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-1">
                                        <img src="<?php echo base_url(); ?>assets/images/laporan.png" alt="Produksi" height="65" width="65">
                                    </div>
                                    <div class="col-4">
                                        <br>
                ...
                <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="card-title col-12">
                                    <h4 class="card-title"><Strong>Performa Sistem</Strong></h4>
                                    <hr>
                                </div>
                            </div>
                                <div class="row">
                                    <div class="col-3">
                                        <img src="<?php echo base_url(); ?>assets/images/performa.png" alt="icon performa" height="115" width="120">
                                    </div>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="card-title col-12">
                                    <h4 class="card-title"><Strong>Total Konsumsi</Strong></h4>
                                    <hr>
                                </div>
                            </div>
                                <div class="row">
                                    <div class="col-3">
                                        <img src="<?php echo base_url(); ?>assets/images/konsumsi.png" alt="icon konsumsi" height="115" width="120">
                                    </div>
                                    <div class="col-8" style="margin-left: 10px">
                                        <br>
                                        <h2 class="card-title" style="color: #5555ff";> 145KW</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/Produksi.png" alt="icon produksi" height="115" width="120">
                                    </div>
                                    <div class="col-6">
                                        <br>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/impor.png" alt="icon impor" height="115" width="120">
                                    </div>
                                    <div class="col-6">
                                        <br>
                                        <h5>Total Impor</h5>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/expor.png" alt="icon expor" height="115" width="120">
                                    </div>
                                    <div class="col-6">
                                        <br>
                                        <h5>Total Expor</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-3">
                                        <img src="<?php echo base_url(); ?>assets/images/tagihan.png" alt="icon icon tagihan" height="115" width="120">
                                    </div>
                                    <div class="col-6">
                                        <br>
                                        <h5> Total Tagihan</h5>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-3">
                                        <img src="<?php echo base_url(); ?>assets/images/penghematan.png" alt="icon penghematan" height="115" width="120">
                                    </div>
                                    <div class="col-6">
                                        <br>
