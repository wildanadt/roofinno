...
<body>
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card bg-transparent">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-1">
                                        <img src="<?php echo base_url(); ?>assets/images/penghematan.png" alt="Produksi" height="65" width="65">
                                    </div>
                                    <div class="col-4">
                                        <br>
                                        <h3> Penghematan</h3>
                ...
                <!-- ============================================================== -->
                <!-- End Selamat Penghematan -->
                <!-- ============================================================== -->
                <!-- ============================================================== -->
                <!-- Penghematan Mingguan -->
                <!-- ============================================================== -->
                 <div class="row">
                    <!-- column -->
                    <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/pohon.png" alt="performa hari ini" height="115" width="115">
                                    </div>
                                    <div class="col-6">
                                        <br>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/co2.png" alt="performa hari ini" height="115" width="115">
                                    </div>
                                    <div class="col-6">
                                        <br>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/energibersih.png" alt="performa hari ini" height="115" width="115">
                                    </div>
                                    <div class="col-6">
                                        <br>
    ...
    <script src="assets/dist/js/pages/dashboards/dashboardpenghematan.js"></script>
</body>
