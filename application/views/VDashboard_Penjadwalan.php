...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <!-- column -->
                                    <div class="col-12">
                                        <div class="ct-sm-line-chart" style="height: 250px;width: 1050px"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <table class="table no-wrap v-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                            <h5 class="mb-0 font-16 font-medium">1</h5>
                                                    </div>
                                                </td>
                                                <td>Beban A</td>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <h5 class="mb-0 font-16 font-medium">200KWh</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <h5 class="mb-0 font-16 font-medium">1200KWh</h5>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <h5 class="mb-0 font-16 font-medium">2</h5>
                                                    </div>
                                                </td>
                                                <td>Beban B</td>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="d-flex no-block align-items-center">
                                                        <h5 class="mb-0 font-16 font-medium">120KWh</h5>
                                                    </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <h5 class="mb-0 font-16 font-medium">1000KWh</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <h5 class="mb-0 font-16 font-medium">3</h5>
                                                    </div>
                                                </td>
                                                <td>Beban C</td>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="d-flex no-block align-items-center">
                                                        <h5 class="mb-0 font-16 font-medium">100KWh</h5>
                                                    </div>
                                                    </div>
                                                </td>
                                                <td>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        <div class="card bg-white">
                                 <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6 style="color: blue"><strong>Beban A</strong></h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <h6 style="color: blue">200Kwh</h6>
                                            </div>
                                        </div>
                                 </div>
                             </div>
                        ...
                        <div class="card-body">
                                 <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <h6 style="color: blue">1200Kwh</h6>
                                            </div>
                                        </div>
                                </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                 <br>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6 style="color: blue"><strong>4 Peralatan</strong></h6>
                                            </div>
                                        </div>
                                </div>
                        </div>
    ...
    <script src="assets/dist/js/pages/dashboards/dashboardpenjadwalan.js"></script>
</body>
