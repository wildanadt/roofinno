    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-12 col-lg-5">
                        <div class="card bg-transparent" >
                            <div class="card-body">
                                <h5 class="card-title" style="color: #FFA500">Selamat Datang Habib</h5> <br>
                                <h3 style="color:white"><strong>Monitor Data Harian</strong></h3>
                                <h5 class="card-subtitle text-white">Selasa, 16 Agustus 2019</h5>    
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                     <div class="col-sm-12 col-lg-3">
                                    <div class="card bg-info" style="color: black">
                                     <div class="info d-flex align-items-center">
                                        <div class="mr-2">
                                            <i class="fas fa-plug fa-3x" style="color:white"></i>
                                        </div>
                                        <div>
                                            <h3 class="text-white mb-0"> 600KWh</h3>
                    ...
                    <div class="col-sm-12 col-lg-3">
                                    <div class="card bg-info">
                                     <div class="info d-flex align-items-center">
                                        ...
                                        <div>
                                            <h3 class="text-white mb-0"> 500KWh</h3>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                        <div class="col-3">
                                            <h4 class="card-title" style="color: blue">10KWh</h4> 
                                            <span><h5 class="card-subtitle">Konsumsi pada 12.00 PM</h5></span>
                                        </div>
                                        <div class="col-3">
                                             <h4 class="card-title" style="color: orange">10KWh</h4>   
                                ...
                                <div class="row">
                                    <!-- column -->
                                    <div class="col-lg-12">
                                        <div class="campaign ct-charts" style="height: 250px"></div>
                                    </div>
                                    <!-- column -->
                                </div>
                                <div class="ml-auto d-flex no-block align-items-center">
                                        <ul class="list-inline font-15 dl mr-3 mb-0" style="margin-left: 70px">
                                            <li class="list-inline-item"><i class="fas fa-check-square" style="color: blue"></i> Konsumsi</li>
                                            <li class="list-inline-item"><i class="fas fa-check-square" style="color: orange"></i> Produksi</li>
                                        </ul>
                                </div>    
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                <!-- Daya baterai, performa hari ini, Performa Hari Ini -->
                <!-- ============================================================== -->
                <div class="row">
                    <!-- column -->
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/dayabaterai.png" alt="performa hari ini" height="115" width="115">
                                    </div>
                                    <div class="col-6">
                                        <br>
                                        <h3>80%</h3>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/penghematan.png" alt="performa hari ini" height="115" width="115">
                                    </div>
                                    <div class="col-6">
                                        <br>
                                        <h3>Rp 134.000</h3>
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="<?php echo base_url(); ?>assets/images/performa.png" alt="performa hari ini" height="115" width="115">
                                    </div>
                                    <div class="col-6">
                                        <br>
                                        <h3>80%</h3>
